...
class WorkerPresenter extends AdminPresenter
{
	...
	): void
	{
		...
		$canManageWorkers = $this->getUser()->isLoggedIn()
			&& $this->getUser()->isAllowed(Resource::WORKER_MANAGEMENT->value);
		...
		$this->template->canManageWorkers = $canManageWorkers;
		$this->template->activeWorkerCount = $canManageWorkers ? $this->babysitterRepository->countActiveWorkers() : 0;
