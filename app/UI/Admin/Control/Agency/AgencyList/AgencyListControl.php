...
class AgencyListControl extends Control
{
	...
	public function render(): void
	{
		...
		$template->setFile(__DIR__ . '/templates/AgencyListControl.latte');
	...
	{
		if ($this->rows === null) {
			$this->rows = $this->agencyRepository->findAgencyRows($this->countryId, $this->statusId);
		}
